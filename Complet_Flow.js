...
const runProducerFinal = async () => {
    ...
    const payloadObject = {
        ...
        "event": {
          ...
          "eventTs": "2025-05-13T19:10:33.207555245Z",
          "source": "Acupick"
        },
        "data": {
          "shipments": [
    ...
    try {
        ...
        const results = await producer.send({
            topic: 'OSPK_OSLM_SHIPPING_LABEL_QA',
...
const payloadOSDTObject = {
    ...
    "fulfillmentOrderNumber": randomFulfillmentOrderNumber,
    "messageSource": "DTILL",
    "publishedTs": "2025-05-13T05:56:34.249738583",
    "storeNumber": "1502",
    ...
    "event": {
        ...
        "eventTs": "2025-05-13T05:56:34.249738583",
        "source": "DTILL"
    },
    "data": {
        "domsJson": {
            "audit": {
                "createDate": "2025-05-13T21:48:24.116Z",
                "modifiedDate": "2025-05-13T05:56:34.246Z",
                "createdBy": "ECOMMERCE",
                "modifiedBy": "PAYMENT_COMPLETED",
                "auditLog": {
                    "FFO_CREATED": "2024-11-18T05:56:30.267",
                    "RECORD_PICK_DETAILS": "2025-05-13T05:56:32.192",
                    "UPDATE_FINAL_PRICE": "2025-05-13T05:56:33.206156002",
                    "PAYMENT_REQUESTED": "2025-05-13T05:56:33.413023026",
                    "TILLING_ORDER_RECEIVED": "2025-05-13T05:56:33.747Z",
                    "PAYMENT_COMPLETED": "2025-05-13T05:56:34.246Z"
                }
            },
            "orderNumber": randomOrderNumber,
            "versionNumber": 1,
            ...
            "orderEditCutoffDate": "2025-05-13T08:00:00.000Z",
            "orderCancelCutoffDate": "2025-05-13T10:00:00.000Z",
            "orderCreatedDate": "2025-05-13T05:56:27.256Z",
